...
#define VIRTUAL_KEY_BASE                  0x400
#define VIRTUAL_KEY_MOUSE_UP             (VIRTUAL_KEY_BASE + 1)
#define VIRTUAL_KEY_MOUSE_DOWN           (VIRTUAL_KEY_BASE + 2)
#define VIRTUAL_KEY_MOUSE_WHEEL_UP       (VIRTUAL_KEY_BASE + 3)
#define VIRTUAL_KEY_MOUSE_WHEEL_DOWN     (VIRTUAL_KEY_BASE + 4)
#define VIRTUAL_KEY_TOUCH_UP             (VIRTUAL_KEY_BASE + 5)
#define VIRTUAL_KEY_TOUCH_DOWN           (VIRTUAL_KEY_BASE + 6)
