...
//Keep the same order as MENU_ITEMS, of course, same MACRO trigger control
enum{
	ITEM_REBOOT  = 0,
	ITEM_APPLY_EXT,
	ITEM_WIPE_DATA,
...
#define ITEM_APPLY_SDCARD    ITEM_APPLY_EXT  // historical synonym for ITEM_APPLY_EXT
...
#ifdef RECOVERY_HAS_EFUSE
//enum { EFUSE_AUDIOLICENSE, EFUSE_ETHMAC, EFUSE_BTMAC, EFUSE_ITEM_MAX };

extern int recovery_efuse(int interactive, char* args);
